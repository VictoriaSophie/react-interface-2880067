// function Search() {
//     // could have done this instead but the 
//     //following is more convenient
// }

import {BiSearch, BiCaretDown} from "react-icons/bi"

// arrow function (just like regular functions)
const Search = () => {
  // parenthesis allow pass along variables
  return (
    // returns html
    <div className="py-5">
...
export default Search //by default want to export component
